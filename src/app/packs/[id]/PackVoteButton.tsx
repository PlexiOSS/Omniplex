...
interface PackVoteButtonProps {
  packUrl: string;
  currentVotes: number;
  voteBanned?: boolean;
}

export function PackVoteButton({
  packUrl,
  currentVotes,
  voteBanned = false,
}: PackVoteButtonProps) {
  ...
  // Packs allow multiple votes over time, but only one vote (in either
