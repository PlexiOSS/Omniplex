...
/** GitHub mark — currentColor so it adapts to theme/hover state. */
...
/** Discord mark — currentColor so it adapts to theme/hover state. */
...
/** X (formerly Twitter) mark — currentColor so it adapts to theme/hover state. */
